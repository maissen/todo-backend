...
def upload_file_to_s3(
    file_bytes: bytes, filename: str, user_id: str, folder: str
) -> tuple[str, str]:
    """
    Upload a file to S3
...
def generate_unique_filename(
    original_filename: str, user_id: str, folder: str
) -> tuple[str, str]:
    """
...
def generate_presigned_upload_url(
    bucket_name: str, object_key: str, content_type: str, expiration: int = 3600
) -> str:
    """
